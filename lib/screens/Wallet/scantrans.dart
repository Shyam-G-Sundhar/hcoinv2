...
class ScanTrans extends StatefulWidget {
  const ScanTrans(
      {super.key, this.name, this.accnum, this.reaccnum, this.code});
  final name, accnum, reaccnum, code;
  @override
  State<ScanTrans> createState() => _ScanTransState();
}

class _ScanTransState extends State<ScanTrans> {
          ...
          child: Column(
            children: [
              ...
              Form(
                ...
                child: TextFormField(
                  controller: TextEditingController(text: widget.accnum),
                  enabled: false,
              ...
              Form(
                ...
                autovalidateMode: AutovalidateMode.onUserInteraction,
                child: TextFormField(
                  controller: TextEditingController(text: widget.reaccnum),
                  enabled: false,
                  keyboardType: TextInputType.number,
                  validator: (value) {
                    if (value!.isEmpty) {
